...
Config.CustomPeds = {
	shared = {
		{label = 'Calle18', maleModel = 's_m_y_cop_01', femaleModel = 's_f_y_cop_01'},
		{label = 'Calle18BLK', maleModel = 's_m_y_ranger_01', femaleModel = 's_m_y_ranger_01'},
		{label = 'Calle18WTE', maleModel = 's_m_y_barman_01', femaleModel = 's_m_y_barman_01'},
